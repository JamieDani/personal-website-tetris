    ...
    >
      {asChild ? (
        <span className="relative inline-flex items-center justify-center gap-1.5">
          ...
          {size === "icon" && (
            <>
              <div className="absolute top-0 left-0 w-full h-[5px] md:h-1.5 bg-border pointer-events-none" />
              <div className="absolute bottom-0 w-full h-[5px] md:h-1.5 bg-border pointer-events-none" />
              <div className="absolute top-1 -left-1 w-[5px] md:w-1.5 h-1/2 bg-border pointer-events-none" />
              <div className="absolute bottom-1 -left-1 w-[5px] md:w-1.5 h-1/2 bg-border pointer-events-none" />
              <div className="absolute top-1 -right-1 w-[5px] md:w-1.5 h-1/2 bg-border pointer-events-none" />
              <div className="absolute bottom-1 -right-1 w-[5px] md:w-1.5 h-1/2 bg-border pointer-events-none" />
            </>
          )}
        </span>
      ) : (
